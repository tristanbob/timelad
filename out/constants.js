...
exports.TEMP_COMMIT_FILE = exports.ERRORS = exports.BACKUP = exports.MESSAGES = exports.GIT_COMMANDS = exports.COMMANDS = exports.GIT_HISTORY_VIEW_ID = exports.COMMIT_DETAILS_VIEW_ID = exports.SIDEBAR_VIEW_ID = exports.GIT_EXTENSION_ID = exports.EXTENSION_NAME = exports.PROGRESSIVE_LOADING = exports.MAX_COMMITS_QUICKPICK = exports.MAX_COMMITS_PANEL = exports.MAX_COMMITS_SIDEBAR = exports.CACHE_TIMEOUT = exports.constants = void 0;
exports.constants = {
    // Cache settings
    ...
    GIT_COMMANDS: {
        ...
        LOG_FORMAT: 'git log -n %d --pretty=format:"%h|%an|%ad|%s" --date=format:"%Y-%m-%d %H:%M:%S"',
    ...
    MESSAGES: {
        ...
        REPO_CREATED_SUCCESS: "🎉 Awesome! Your project is now set up for version tracking. You can see your work history in the TimeLad sidebar!",
    ...
    // Error messages
    ERRORS: {
        GIT_EXTENSION_NOT_FOUND: "Git extension not found. Please ensure Git is installed and the Git extension is enabled.",
        GIT_EXTENSION_NOT_READY: "Git extension is not ready yet. Please wait a moment and try again.",
        GIT_NOT_INSTALLED: "Git is not installed on this system. Please install Git and restart VS Code.",
        NO_REPOSITORIES: "No Git repositories found in the current workspace. Please open a Git repository.",
        ...
        GITHUB_AUTH_FAILED: "GitHub authentication failed. Please check your token.",
...
exports.CACHE_TIMEOUT = exports.constants.CACHE_TIMEOUT;
exports.MAX_COMMITS_SIDEBAR = exports.constants.MAX_COMMITS_SIDEBAR;
exports.MAX_COMMITS_PANEL = exports.constants.MAX_COMMITS_PANEL;
exports.MAX_COMMITS_QUICKPICK = exports.constants.MAX_COMMITS_QUICKPICK;
exports.PROGRESSIVE_LOADING = exports.constants.PROGRESSIVE_LOADING;
exports.EXTENSION_NAME = exports.constants.EXTENSION_NAME;
exports.GIT_EXTENSION_ID = exports.constants.GIT_EXTENSION_ID;
exports.SIDEBAR_VIEW_ID = exports.constants.SIDEBAR_VIEW_ID;
exports.COMMIT_DETAILS_VIEW_ID = exports.constants.COMMIT_DETAILS_VIEW_ID;
exports.GIT_HISTORY_VIEW_ID = exports.constants.GIT_HISTORY_VIEW_ID;
exports.COMMANDS = exports.constants.COMMANDS;
exports.GIT_COMMANDS = exports.constants.GIT_COMMANDS;
exports.MESSAGES = exports.constants.MESSAGES;
exports.BACKUP = exports.constants.BACKUP;
exports.ERRORS = exports.constants.ERRORS;
exports.TEMP_COMMIT_FILE = exports.constants.TEMP_COMMIT_FILE;
